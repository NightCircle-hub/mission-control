...
// Validate ../../../app/api/taskboard/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/taskboard">> = Specific
  const handler = {} as typeof import("../../../app/api/taskboard/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
