...
"[project]/app/api/taskboard/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const data = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(taskboardPath, 'utf-8');
        const taskboard = JSON.parse(data);
        console.log(`Loaded ${taskboard.tasks.length} tasks`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(taskboard);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0o4t129._.js.map